...
windowsBtn.addEventListener("click", changeSub);

const mainPage = document.getElementById("main");

const nameBox = document.getElementById("name");
const nameSub1 = document.getElementById("name-sub1");
const nameSub2 = document.getElementById("name-sub2");
...
const themes = [
  ...
  `url('aberrant-01.jpg')`,
  `url('metallic-04.jpg')`,
  `url('dispersion-09.jpg')`,

  `url('neon-09.jpg')`,
  `url('iridescent-11.jpg')`,
];
let index1 = 0;
let index2 = 0;

function changeSub() {
  mainPage.style.backgroundImage = themes[index1];
  index1 = (index1 + 1) % themes.length;

  nameSub1.innerText = "";
  nameSub2.innerText = subs[index2];
  nameBox.appendChild(nameSub2);
  index2 = (index2 + 1) % subs.length;
}
